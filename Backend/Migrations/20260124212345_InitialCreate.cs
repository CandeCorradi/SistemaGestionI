...
namespace Backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        //    migrationBuilder.InsertData(
        //        table: "Mayoristas",
        //        columns: new[] { "Id", "Apellido", "Direccion", "Email", "IsDeleted", "Nombre", "Telefono", "TipoProducto" },
        //        values: new object[,]
        //        {
        ...
        //        values: new object[,]
        //        {
        //            { 1, new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1108), false, 15000m, 10, "Tarjeta de Credito" },
        //            { 2, new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1139), false, 250000m, 11, "Efectivo" },
        //            { 3, new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1142), false, 305000m, 12, "Tarjeta de Débito" }
        //        });
        ...
        //        values: new object[,]
        //        {
        //            { 10, 1, "En Proceso", new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1221), false },
        //            { 11, 2, "Completado", new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1227), false },
        //            { 12, 3, "Pendiente", new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1231), false }
        //        });
        ...
        //        values: new object[,]
        //        {
        //            { 1, 1, new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1314), new DateTime(2026, 2, 23, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1316), false, 50000m },
        ...
        //            { 3, 3, new DateTime(2026, 1, 24, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1338), new DateTime(2026, 2, 23, 18, 23, 42, 516, DateTimeKind.Local).AddTicks(1339), false, 20000m }
        //        });
        ...
        //        values: new object[,]
        //        {
        //            { 1, "Melamina", "Melamina de alta calidad color blanco", false, "21 * 12", "Melamina Blanca", 0m, 50 },
        //            { 2, "Melamina", "Melamina de alta calidad, textura granulada", false, "21 * 12", "Melamina Caoba", 0m, 15 },
        //            { 3, "Melamina", "Melamina de alta calidad, textura mate", false, "21 * 12", "Melamina Negra", 0m, 43 }
        //        });
        }
